...
const accommodationDetails={"21 July": {"name": "Familievennlig leilighet med gode solforhold", "subtitle": "Private Airbnb accommodation in Fana", "type": "Airbnb check-in", "description": "Your booked entire-home apartment in Fana. The stay is family-oriented and has self check-in. The public website shows the property name and area but does not publish the keypad, reservation code, phone number or exact street address.", "transport": "From Bergen Airport, use Bybanen toward Bergen and follow the private Airbnb directions for the final connection to Fana. Keep the check-in guide available offline.", "image": "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1400&q=86", "map": "Fana+Bergen+Norway", "official": "#", "facts": ["Afternoon check-in", "Morning check-out", "Entire home", "Self check-in"]}, "23 July": {"name": "Scandic Byporten", "subtitle": "Confirmed Oslo hotel · connected to Oslo Central Station", "type": "Hotel check-in", "description": "Your confirmed Standard Hotel Room at Scandic Byporten. The hotel sits under the same roof as Byporten Shopping Centre and directly beside Oslo Central Station.", "transport": "After leaving the train, follow signs for Byporten Shopping Centre. Walk into the plaza, turn right and use the revolving-door hotel entrance.", "image": "https://images.scandichotels.com/publishedmedia/vznsjc994p3m719y7ev7/scandic-byporten-facade-1.jpg", "map": "Scandic+Byporten+Oslo", "official": "#", "facts": ["Afternoon check-in", "Morning check-out", "Standard Hotel Room", ""]}, "25 July": {"name": "CABINN Metro", "subtitle": "Confirmed Copenhagen hotel · near Ørestad and Bella Center", "type": "Hotel check-in", "description": "Your confirmed two-room stay at CABINN Metro. The hotel is a distinctive designer property near Ørestad station, Bella Center and the airport transport corridor.", "transport": "Use Rejseplanen from the cruise terminal to Ørestad. From Ørestad station, continue on foot or by local bus depending on luggage and weather.", "image": "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?auto=format&fit=crop&w=1400&q=86", "map": "CABINN+Metro+Copenhagen", "official": "#", "facts": ["Afternoon check-in", "Morning check-out", "2 Standard Rooms", "Breakfast available separately"]}};
